...
@SelectColumnMappings({
  @SelectColumnMapping(property = "id", type = Long.class, table = "ADC_PRODUCT", tableAlias = "A", column = "ID"),
  @SelectColumnMapping(property = "name", type = String.class, table = "ADC_PRODUCT", tableAlias = "A", column = "NAME"),
  @SelectColumnMapping(property = "createDate", type = Date.class, table = "ADC_PRODUCT", tableAlias = "A", column = "CREATE_DATE"),
  @SelectColumnMapping(property = "linkUrl", type = String.class, table = "ADC_PRODUCT", tableAlias = "A", column = "LINK_URL"),
  @SelectColumnMapping(property = "section", type = BigDecimal.class, table = "ADC_PRODUCT", tableAlias = "A", column = "SECTION")
})
