	...
	public String getLimitString(String sql, int offset, String offsetPlaceholder, int limit, String limitPlaceholder) {
		...
		return (new StringBuffer(sql.length() + 10))
				...
				.insert(sql.toLowerCase().indexOf("select") + 6,
						hasOffset ? (new StringBuilder()).append(" limit ").append(offsetPlaceholder).append(" ")
								.append(limitPlaceholder).toString() : (new StringBuilder()).append(" top ")
								.append(limitPlaceholder).toString()).toString();
	}
}