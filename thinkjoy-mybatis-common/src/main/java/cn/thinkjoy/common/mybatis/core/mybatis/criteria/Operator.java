...
public enum Operator {
	...
	NOT_BETWEEN(" NOT BETWEEN "), BETWEEN(" BETWEEN "), IN(" IN "), NOT_IN(" NOT IN "), NOT(" NOT "), NOT_EQ(" <> "), EQ(
			" = "), GT(" > "), LT(" < "), LE(" <= "), GE(" >= "), LIKE(" LIKE "), IS_NOT_NULL(" IS NOT NULL "), IS_NULL(
			" IS NULL "), BIT_EQ(" & "), BIT_OR(" | ");
