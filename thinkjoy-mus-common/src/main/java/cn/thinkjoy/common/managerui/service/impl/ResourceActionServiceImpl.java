 ...
 *
 * Project Name: ehr
 * $Id:  ResourceActionServiceImpl.java 2014-10-03 17:08:04 $
 */
...
@Service("ResourceActionServiceImpl")
public class ResourceActionServiceImpl extends AbstractPageService<IResourceActionDAO,ResourceAction> implements IResourceActionService{
    @Autowired
    private IResourceActionDAO resourceActionDAO;

    @Override
    public IResourceActionDAO getDao() {
...
//        return resourceActionDAO.findAll();
//    }
//
//    @Override
...
//
//    @Override
//    protected ResourceActionDAO getDao() {
//        return resourceActionDAO;
//    }
//
//    @Override
