...
import cn.thinkjoy.common.managerui.dao.IUserDatagroupDAO;
...
public class UserDatagroupServiceImpl extends AbstractPageService<IBaseDAO<UserDatagroup>, UserDatagroup> implements IUserDatagroupService<IBaseDAO<UserDatagroup>,UserDatagroup>{
    @Autowired
    private IUserDatagroupDAO userDatagroupDAO;

    @Override
    public IBaseDAO<UserDatagroup> getDao() {
