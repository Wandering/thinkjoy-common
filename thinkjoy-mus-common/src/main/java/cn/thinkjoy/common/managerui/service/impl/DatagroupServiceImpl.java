...
import cn.thinkjoy.common.managerui.dao.IDatagroupDAO;
import cn.thinkjoy.common.managerui.domain.Datagroup;
...
public class DatagroupServiceImpl extends AbstractPageService<IBaseDAO<Datagroup>, Datagroup> implements IDatagroupService<IBaseDAO<Datagroup>,Datagroup>{
    @Autowired
    private IDatagroupDAO datagroupDAO;

    @Override
    public IBaseDAO<Datagroup> getDao() {
        return datagroupDAO;
    }
