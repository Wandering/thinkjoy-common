...
import cn.thinkjoy.common.managerui.dao.IDatagroupDataDAO;
...
public class DatagroupDataServiceImpl extends AbstractPageService<IBaseDAO<DatagroupData>, DatagroupData> implements IDatagroupDataService<IBaseDAO<DatagroupData>,DatagroupData>{
    @Autowired
    private IDatagroupDataDAO datagroupDataDAO;

    @Override
    public IBaseDAO<DatagroupData> getDao() {
